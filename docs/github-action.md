...
[`deploy/github-action/`](https://github.com/Daybreak-AI-Labs/Law_Firm/blob/main/deploy/github-action/). Hand it a goal (or a
[goal template](https://github.com/Daybreak-AI-Labs/Law_Firm/blob/main/benchmarks/example-templates/)) and a dollar cap; it
installs from that reviewed Maverick checkout, runs `maverick start`, and writes the answer to
the job summary.
...
jobs:
  run:
    ...
    steps:
      - uses: Daybreak-AI-Labs/Law_Firm/deploy/github-action@<reviewed-full-40-character-commit-sha>
        with:
          goal: ${{ inputs.goal }}
          max-dollars: "0.50"
...
[`deploy/github-action/README.md`](https://github.com/Daybreak-AI-Labs/Law_Firm/blob/main/deploy/github-action/README.md).
...
[`.github/workflows/github-action.yml`](https://github.com/Daybreak-AI-Labs/Law_Firm/blob/main/.github/workflows/github-action.yml).
