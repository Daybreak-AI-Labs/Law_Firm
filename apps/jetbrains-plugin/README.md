# Maverick JetBrains plugin (live-run scaffold)

A minimal IntelliJ-platform plugin: a **Maverick Runs** tool window that
...
dashboard URL/token under Settings → Tools → Maverick.
